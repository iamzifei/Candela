...
[官网](https://getcandela.app/zh/) ·
[与 BetterDisplay、Lunar 对比](https://getcandela.app/zh/candela-vs-betterdisplay.html) ·
[使用指南](https://getcandela.app/zh/fix-blurry-external-monitor-macos.html) ·
**[English](README.md)**
...
[完整对比，包括 Candela 做不到的部分 →](https://getcandela.app/zh/candela-vs-betterdisplay.html)
