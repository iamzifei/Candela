// Candela/Services/BrightnessBoostService.swift
import AppKit
import CoreGraphics
...
final class BrightnessBoostService {
    ...
    private func enabledKey(_ uuid: String) -> String { "candela.BoostEnabled.\(uuid)" }
    ...
    /// made outside Candela (System Settings): every HDR flip fires a screen
